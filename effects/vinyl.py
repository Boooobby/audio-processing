...
class VinylStyle(AudioEffect):
    ...
    def generate_colored_noise(self, shape, color='pink'):
        ...
        if color == 'pink' or color == 'brown':
            # 简单的累积求和模拟布朗噪声(Brownian Noise)，比白噪声听起来更像低频轰隆声
